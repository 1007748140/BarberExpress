...
], CreateBankAccountDto.prototype, "documentTypeId", void 0);
__decorate([
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El tipo de cuenta es requerido' }),
    __metadata("design:type", Number)
], CreateBankAccountDto.prototype, "accountTypeId", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El nombre del banco es requerido' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El nombre del titular es requerido' }),
    __metadata("design:type", String)
], CreateBankAccountDto.prototype, "accountOwner", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El número de documento es requerido' }),
    __metadata("design:type", String)
], CreateBankAccountDto.prototype, "documentNumber", void 0);
